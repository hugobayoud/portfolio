...
interface SparklesProps {
  /** Array of sparkle objects to render */
  sparkles: Sparkle[];
  /** Callback when sparkles animation completes */
  onAnimationComplete: () => void;
  /** Container size for positioning calculations */
 ...
 * @param containerSize - Size of the container for proper positioning
 */
